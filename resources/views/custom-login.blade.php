    ...
    <div class="card-body">
        <form method="POST" action="{{route('custom.login.post')}}">
            ...
            <div class="form-floating mb-3">
                <input naria-describedby="inputEmailFeedback" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmail" type="email" placeholder="name@example.com" />
